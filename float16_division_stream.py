...
st.set_page_config(page_title="Float16 Divider", layout="centered")
st.markdown("<h2 style='text-align:center;'>Float16 Divider</h2><hr>", unsafe_allow_html=True)
...
with col1:
    a_str = st.text_input("Enter numerator (decimal or 0xABCD):", "")
with col2:
    b_str = st.text_input("Enter denominator (same format as numerator):", "")
